...
CREATE INDEX IF NOT EXISTS idx_user_sessions_vendor_chat ON user_sessions(in_vendor_chat) WHERE in_vendor_chat = TRUE;
CREATE INDEX IF NOT EXISTS idx_user_sessions_assigned_vendor ON user_sessions(assigned_vendor_phone) WHERE assigned_vendor_phone IS NOT NULL;
...
CREATE INDEX IF NOT EXISTS idx_customer_messages_phone ON customer_messages(customer_phone);
CREATE INDEX IF NOT EXISTS idx_customer_messages_unread ON customer_messages(read) WHERE read = FALSE;
