...
-- Crear tabla vendor_hours si no existe
...
-- Políticas para vendor_hours (lectura pública)
CREATE POLICY "Anyone can view vendor hours" ON public.vendor_hours
    FOR SELECT USING (true);

CREATE POLICY "Vendors can manage their hours" ON public.vendor_hours
    FOR ALL USING (
        EXISTS (
            SELECT 1 FROM vendors 
...
-- Ahora insertar todos los datos
-- Primero limpiar cualquier dato existente
...
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Pizzería Don Luigi', 'restaurant', '+595971234567', '+595971234567', 'Av. España 1234, Asunción', true, 4.8, 1250, 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38', '00000000-0000-0000-0000-000000000000'),
('b2c3d4e5-f6a7-8901-bcde-f23456789012', 'Burger House', 'restaurant', '+595982345678', '+595982345678', 'Av. Mariscal López 5678, Asunción', true, 4.6, 890, 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd', '00000000-0000-0000-0000-000000000000'),
('c3d4e5f6-a7b8-9012-cdef-345678901234', 'Farmacia San José', 'pharmacy', '+595993456789', '+595993456789', 'Av. San Martín 910, Asunción', true, 4.9, 2100, 'https://images.unsplash.com/photo-1576602976047-174e57a47881', '00000000-0000-0000-0000-000000000000'),
('d4e5f6a7-b8c9-0123-defa-456789012345', 'Supermercado El Ahorro', 'market', '+595974567890', '+595974567890', 'Av. Artigas 1112, Asunción', true, 4.5, 3200, 'https://images.unsplash.com/photo-1542838132-92c53300491e', '00000000-0000-0000-0000-000000000000'),
('e5f6a7b8-c9d0-1234-efab-567890123456', 'Heladería Italiana', 'restaurant', '+595985678901', '+595985678901', 'Shopping del Sol, Asunción', true, 4.7, 670, 'https://images.unsplash.com/photo-1563589173312-476d8c36b242', '00000000-0000-0000-0000-000000000000'),
('f6a7b8c9-d0e1-2345-fabc-678901234567', 'Lapacho Restaurant', 'restaurant', '+595996789012', '+595996789012', 'Av. Santa Teresa 2345, Asunción', true, 4.9, 1450, 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0', '00000000-0000-0000-0000-000000000000');
