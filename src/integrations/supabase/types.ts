...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      vendor_change_analytics: {
        Row: {
          ...
          pending_vendor_id: string
          pending_vendor_name: string
    ...
    Views: {
      ...
      vendor_change_metrics: {
        Row: {
          action: string | null
          avg_cart_items: number | null
      ...
      vendor_change_summary: {
        Row: {
          ...
          net_customer_change: number | null
